...
export function generateProjectFinancialEmailHTML(
  projectName: string,
  customerName: string,
...
<head>
  ...
  <title>Project Financial Summary</title>
</head>
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="margin-bottom: 30px;">
    ...
    <p>Please find attached the financial summary for your project: <strong>${projectName}</strong>.</p>
    <p>This summary includes all financial details, documents, and current status for the project.</p>
  </div>
  ...
  <div style="background: #F9FAFB; padding: 15px; border-radius: 8px; margin-bottom: 30px;">
    ...
    <ul style="margin: 10px 0 0 20px; color: #6B7280; font-size: 14px;">
      <li>Project financial overview</li>
      <li>All related documents (estimates, invoices, change orders)</li>
  ...
  <div style="margin-bottom: 30px;">
    <p>If you have any questions about the project finances, please contact your project manager.</p>
